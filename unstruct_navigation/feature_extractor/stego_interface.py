...
from unsup_seg.data import create_cityscapes_colormap
...
class StegoInterface:
    def __init__(
        ...
        model_path: str = f"/home/offroad/data/models/epoch=9-step=390.ckpt",
        ...
        self._model = UnsupSeg.load_from_checkpoint(self._cfg.model_path, n_image_clusters=self._cfg.n_image_clusters)
