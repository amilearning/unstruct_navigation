...
class SimpleCarDynamics:
    ...
    def __init__(
        ...
        self.block_dim = 1024 #min(MPPI_config["ROLLOUTS"], 1024) # use 32 for jetson, use 1024 for RTX GPUs
        ...
        file_path = "/home/offroad/stego_ws/src/unstruct_navigation/unstruct_navigation/mppi/slip3d.cpp"
    ...
    def forward(self, state, controls):
        ...
        self.rollout(state_, controls, self.dt, self.K, self.T, self.NX, self.NC,
